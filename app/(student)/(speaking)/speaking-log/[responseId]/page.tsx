...
export default function SpeakingLogDetailPage() {
    ...
    // Find the clicked response, then gather all responses from the same assignment session
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <div className="text-xs font-semibold uppercase tracking-[0.15em] text-slate-400">
                                                Step {(response.stepIndex ?? index) + 1} of {response.stepTotal ?? sessionResponses.length}
                                            </div>
